...
- `ArkLib` — 434 files, 7594 declarations

## Same short-name across multiple files (216 groups)
...
### `Prover` (2 declarations, 2 files)

- `abbrev Interaction.Prover` [ArkLib/Interaction/Reduction.lean:105](../../../ArkLib/Interaction/Reduction.lean#L105) — A prover performs monadic setup and returns the focal strategy for the selected input.
- `structure Prover` [ArkLib/OracleReduction/Basic.lean:220](../../../ArkLib/OracleReduction/Basic.lean#L220) — The type of honest provers for an interactive reduction with `n` messages. This consists of: - `PrvS

### `Reduction` (2 declarations, 2 files)

- `structure Interaction.Reduction` [ArkLib/Interaction/Reduction.lean:129](../../../ArkLib/Interaction/Reduction.lean#L129) — A plain dependent reduction pairs a prover and verifier for one typed interaction.
- `structure Reduction` [ArkLib/OracleReduction/Basic.lean:622](../../../ArkLib/OracleReduction/Basic.lean#L622) — An **interactive reduction** for a given protocol specification `pSpec`, and relative to oracles def
...
### `Verifier` (2 declarations, 2 files)

- `abbrev Interaction.Verifier` [ArkLib/Interaction/Reduction.lean:118](../../../ArkLib/Interaction/Reduction.lean#L118) — A verifier returns the counterpart strategy for the selected input and public statement.
- `structure Verifier` [ArkLib/OracleReduction/Basic.lean:245](../../../ArkLib/OracleReduction/Basic.lean#L245) — A verifier of an interactive protocol is a function that takes in the input statement and the transc

### `Verifier.run` (2 declarations, 2 files)

- `def Interaction.Verifier.run` [ArkLib/Interaction/Reduction.lean:171](../../../ArkLib/Interaction/Reduction.lean#L171) — Run a focal strategy against an input-indexed verifier.
- `def Verifier.run` [ArkLib/OracleReduction/Execution.lean:176](../../../ArkLib/OracleReduction/Execution.lean#L176) — Run the (non-oracle) verifier in an interactive reduction. It takes in the input statement and the t
...
### `done` (2 declarations, 2 files)

- `def Interaction.Oracle.Protocol.done` [ArkLib/Interaction/Oracle/Protocol.lean:43](../../../ArkLib/Interaction/Oracle/Protocol.lean#L43) — Terminal decorated protocol.
- `def Interaction.Oracle.TypeTree.done` [ArkLib/Interaction/Oracle/TypeTree.lean:67](../../../ArkLib/Interaction/Oracle/TypeTree.lean#L67) — Terminal oracle interaction tree.
